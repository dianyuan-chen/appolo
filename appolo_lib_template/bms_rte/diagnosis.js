...
module.exports = {
    process: function(cfgData, info) {
        ...
        var diagnosisitems = [
            ...
            {name:"碰撞故障", diagnosisType:"HIGH", condition:"ALL", def:"CRASH_FAULT", getval:"UserStrategy_GetCrashFault"},
            {name:"热失控", diagnosisType:"HIGH", condition:"ALL", def:"THERMAL_RUNAWAY", altdef:["NONE_CALIBRATE_STOP"], getval:"TemperatureM_IsThermalRunawayFault"},
        ];
        ...
        for (var index = 0; index < diagnosisitems.length; index++) {
            ...
            var reportFlag = 15;
            if (cfgItem && cfgItem.report_levels) {
                reportFlag = cfgItem.report_levels.toLevelMask();
            }
            var startDiagnosis = {};
